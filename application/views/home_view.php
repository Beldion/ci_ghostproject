                            ...
                            <div class="parrent media-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade" id="tab1">
                                        <div class="media">
                                           <div class="pull-left">
                                                <img class="img-responsive" src="<?php echo base_url('assets/images/tab2.png'); ?>">
                                            </div>
                                            <div class="media-body">
                                                 <h2>Adipisicing elit</h2>
                                     ...
                                     <div class="tab-pane fade active in" id="tab2">
                                        <div class="media">
                                           <div class="pull-left">
                                                <img class="img-responsive" src="<?php echo base_url('assets/images/tab1.png'); ?>">
                                            </div>
                                            <div class="media-body">
                                                 <h2>Adipisicing elit</h2>
                        ...
                        <h2>Testimonials</h2>
                         <div class="media testimonial-inner">
                            ...
                            <div class="media-body">
                                ...
                                <span><strong>-Bryan Balanan/</strong> Director NetForgeStudios</span>
                            </div>
                         </div>
